    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>admin/tax_details/insert"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pan" id="pan" placeholder="Enter Pan Number" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="mobile" id="mobile" placeholder="Enter Phone Number" class="form-control">
                        </div>
                    </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="website" id="website" placeholder="Enter Website Url" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cust_name" id="cust_name" placeholder="Enter Namer" class="form-control" >
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cust_email" id="cust_email" placeholder="Enter Email" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cust_phone" id="cust_phone" placeholder="Enter Number" class="form-control" >
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cust_place" id="cust_place" placeholder="Enter Gst Number" class="form-control" > 
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="cust_address" id="cust_address" placeholder="Address"></textarea>
                        </div>
                    </div>
                    ...
                    <!--    <div class="col-sm-10">-->
                    <!--        <input type="text" name="bank_name" id="bank_name" placeholder="Enter Bank Number" class="form-control" > -->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <!--    <div class="col-sm-10">-->
                    <!--        <input type="text" name="ifsc" id="ifsc" placeholder="Enter Code" class="form-control" > -->
                    <!--    </div>-->
                    <!--</div>-->
