                                ...
                                foreach ($ads as $v) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <?php
                                        if($user_type=='subadmin'){}else{ ?>
                                            <a href="<?= base_url() ?>admin/ads/edit/<?= $v->id ?>">
                                                <button title="This operation is disabled in demo !" class="btn btn-xs btn-primary">
                                                    Edit
                                                </button>
                                            </a>
                                            <a href="<?= base_url() ?>admin/ads/delete/<?= $v->id ?>">
                                                <button title="Delete Ads" class="btn btn-xs btn-danger">
                                                    Delete
                                                </button>
                                            </a>
                                        <?php } ?>
