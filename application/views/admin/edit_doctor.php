    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content test">
                <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?= base_url() ?>admin/doctors/update">
                    <input type="hidden" name="id" value="<?=$doctors_data->id?>">
                    <div class="form-group">

                        <label class="col-sm-2 control-label">Hospital Name</label>
                        <div class="col-sm-10">
                            <input type="text" id="hospital_name" name="hospital_name" class="form-control" value="<?=$doctors_data->hospital_name?>">
                        </div>
                    </div>
                     <?php

                    if ($doctors_data->hospital_image) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img width="200px" src="<?= base_url() ?>uploads/doctors/<?= $doctors_data->hospital_image ?> "/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="doctor_name" name="doctor_name" class="form-control" value="<?=$doctors_data->doctor_name?>">
                        </div>
                    </div>
                    ...
                    if ($doctors_data->doctor_image) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img width="200px" src="<?= base_url() ?>uploads/doctors/<?= $doctors_data->doctor_image ?> "/>
                    ...
                    if ($doctors_data->digital_signature) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img width="200px" src="<?= base_url() ?>uploads/doctors/<?= $doctors_data->digital_signature ?> "/>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="state_id" id="states" onchange="getStateID(this.value)">
                                ...
                                foreach ($state_list as $st) {
                                    ?>
                                    <option value="<?php echo $st->id; ?>" <?=$st->id==$doctors_data->state?"selected":""?>><?php echo $st->state_name; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                            ...
                            <select class="form-control" name="city_id" id="cities" onchange="getLocations(this.value)">
                                ...
                                <?php
                                   foreach($cities as $city){
                                    ?>
                                        <option value="<?php echo $city->id; ?>" <?=$city->id==$doctors_data->city?"selected":""?>><?php echo $city->city_name; ?></option>
                                    <?php
                                   }
                                ?>
                                ...
                                <option value="">Select Pincode</option>
                                 <?php
                                   foreach($pincodes as $row){
                                    ?>
                                        <option value="<?php echo $row->id; ?>" <?=$row->id==$doctors_data->pincode?"selected":""?>><?php echo $row->pincode; ?></option>
                                    <?php
                                   }
                                ?>
                    ...
                    <?php
                        $designations = explode(',',$doctors_data->designations);
                    ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="designations" name="designations[]" class="form-control js-example-basic-multiple" multiple="multiple">
                                ...
                                <?php $designation_qry = $this->db->query("select * from designations where status=1"); 
                                      ...
                                      { ?>
                                <option value="<?php echo $d_value->id; ?>" <?=in_array($d_value->id, $designations)?"selected":""?> ><?php echo $d_value->name; ?></option>
                                  <?php } ?>
                            </select>
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php foreach ($specialisation as $spl) { ?>
                                    <option value="<?= $spl->id ?>"<?=$spl->id==$doctors_data->specialisation?"selected":""?>><?= $spl->name ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                     ...
                     <?php
                        $specialist = explode(',',$doctors_data->specialist_in);
                    ?>
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="specialist" name="specialist[]" class="form-control js-example-basic-multiple" multiple="multiple">
                                ...
                                <?php $designation_qry = $this->db->query("select * from specialist_in where status=1"); 
                                      ...
                                      foreach ($designation_result as $d_value) 
                                      { ?>
                                <option value="<?php echo $d_value->id; ?>"<?=in_array($d_value->id, $specialist)?"selected":""?>  ><?php echo $d_value->specialist_in; ?></option>
                                  <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  onkeyup="getMobile(this.value)"  onkeypress="return isNumberKey(event)" title="Please enter exactly 10 digits" id="mobile_number" name="mobile_number" class="form-control" value="<?=$doctors_data->mobile_number?>">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="address" name="address" class="form-control"><?=$doctors_data->address?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="experience" name="experience" class="form-control" value="<?=$doctors_data->experience?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">Voice Call Consultation Fee</label>
                        <div class="col-sm-10">
                            <input type="text" id="consultant_fee_voice_call" name="consultant_fee_voice_call" class="form-control" value="<?=$doctors_data->voice_call?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="consultant_fee_video_call" name="consultant_fee_video_call" class="form-control" value="<?=$doctors_data->video_call?>">
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="consultant_fee_chat" name="consultant_fee_chat" class="form-control" value="<?=$doctors_data->chat_price?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="aboutus" name="aboutus" class="form-control"><?=$doctors_data->aboutus?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="youtube_channel_id" name="youtube_channel_id" class="form-control" value="<?=$doctors_data->youtube_channel_id?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="tags" name="tags" class="form-control" value="<?=$doctors_data->tags?>">
                        </div>
                    </div>
                     <div class="row">
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                      <input type="time" id="morning_start_time" name="morning_start_time" class="form-control" value="<?=$doctors_data->morning_start_time?>">
                                  </div>

                                  <label class="col-sm-2 control-label">Morning End Time</label>
                                <div class="col-sm-4">
                                    <input type="time" id="morning_end_time" name="morning_end_time" class="form-control" value="<?=$doctors_data->morning_end_time?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                      <input type="time" id="afternoon_start_time" name="afternoon_start_time" class="form-control" value="<?=$doctors_data->afternoon_start_time?>">
                                  </div>

                                  <label class="col-sm-2 control-label">Afternoon End Time</label>
                                <div class="col-sm-4">
                                    <input type="time" id="afternoon_end_time" name="afternoon_end_time" class="form-control" value="<?=$doctors_data->afternoon_end_time?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                      <input type="time" id="evening_start_time" name="evening_start_time" class="form-control" value="<?=$doctors_data->evening_start_time?>">
                                  </div>

                                  <label class="col-sm-2 control-label">Evening End Time</label>
                                <div class="col-sm-4">
                                    <input type="time" id="evening_end_time" name="evening_end_time" class="form-control" value="<?=$doctors_data->evening_end_time?>">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="bluetick_status" name="bluetick_status">
                                <option value="" selected="">Select Status</option>
                                    <option value="active"<?=$doctors_data->blue_tick=="active"?"selected":""?> >Active</option>
                                   <option value="inactive" <?=$doctors_data->blue_tick=="inactive"?"selected":""?>>InActive</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="doctor_rating" name="doctor_rating">
                                <option value="" selected="">Select Rating</option>
                                   <option value="1" <?=$doctors_data->rating=="1"?"selected":""?> >1-Star</option> 
                                   <option value="2" <?=$doctors_data->rating=="2"?"selected":""?>>2-Star</option> 
                                   <option value="3" <?=$doctors_data->rating=="3"?"selected":""?>>3-Star</option> 
                                   <option value="4" <?=$doctors_data->rating=="4"?"selected":""?>>4-Star</option>
                                   <option value="5" <?=$doctors_data->rating=="5"?"selected":""?>>5-Star</option>
                            </select>
                        </div>
                    </div>
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="users_count" name="users_count" class="form-control" value="<?=$doctors_data->rating_count?>">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="doctor_show_status" name="doctor_show_status">
                                <option value="" selected="">Select Doctor Show Status</option>
                                    <option value="active" <?=$doctors_data->doctor_show_status=="active"?"selected":""?>>Active</option>
                                   <option value="inactive"  <?=$doctors_data->doctor_show_status=="inactive"?"selected":""?>>InActive</option>
                            </select>
                        </div>
                    </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="doctor_login_status" name="doctor_login_status">
                                <option value="">Select Vendor Login Status</option>
                                    <option value="active"  <?=$doctors_data->doctor_login_status=="active"?"selected":""?>>Active</option>
                                   <option value="inactive" <?=$doctors_data->doctor_login_status=="inactive"?"selected":""?>>InActive</option>
                            </select>
                        </div>
                    </div>
                    <!-- <div class="form-group">-->
                    ...
                    <!--    <div class="col-sm-10">-->
                    <!--        <input type="text" id="gst_number" name="gst_number" class="form-control" value="<?=$doctors_data->gst_number?>">-->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <!--    <div class="col-sm-10">-->
                    <!--        <input type="text" id="pan_number" name="pan_number" class="form-control" value="<?=$doctors_data->pan_number?>">-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Latitude</label>
                        <div class="col-sm-10">
                            <input type="text" id="latitude" name="latitude" class="form-control" value="<?=$doctors_data->latitude?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="longitude" name="longitude" class="form-control" value="<?=$doctors_data->longitude?>">
                        </div>
                    </div>
...
<script type="text/javascript">
 ...
 var Extension = FileUploadPath.substring(FileUploadPath.lastIndexOf('.') + 1).toLowerCase();
    var ph = $('#mobile_number').val();
      ...
      {
         $('#consultant_fee_voice_call').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter consultant fee (voice call)</span>');
         $('#consultant_fee_voice_call').focus();
         return false;
      }
        else if($('#consultant_fee_video_call').val()=='')
      {
         $('#consultant_fee_video_call').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter consultant fee (video call)</span>');
      ...
      else if($('#lalitude').val()=='')
      {
         $('#lalitude').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter Latitude</span>');
         $('#lalitude').focus();
         return false;
      }
      ...
      {
         $('#morning_end_time').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter Morming End Tags</span>');
      ...
      {
         $('#doctor_show_status').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter Doctors Status</span>');
      ...
      {
         $('#doctor_login_status').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Enter Doctor Login Status</span>');
