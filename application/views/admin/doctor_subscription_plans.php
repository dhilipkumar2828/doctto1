        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 class="plan_title">Doctor Subscription Plans</h5>
                    <div class="ibox-tools">
                        <a href="<?= base_url() ?>admin/dashboard">
                            <button class="btn btn-primary">BACK</button>
                        </a>
                        <a href="<?= base_url() ?>admin/doctor_subscription_plans/add">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <?php if ($plans): ?>
                                    <?php foreach ($plans as $plan): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="perks-text" title="<?= $plan->perks ?>">
                                                    <?= strlen($plan->perks) > 30 ? substr($plan->perks, 0, 30) . '...' : $plan->perks ?>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge badge-info">
                                                    <?= $plan->active_subscriptions_count ? $plan->active_subscriptions_count : 0 ?>
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?= base_url() ?>admin/doctor_subscription_plans/edit/<?= $plan->id ?>" 
                                                       class="btn btn-xs btn-primary" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    
                                                    <?php if ($plan->is_active == 1): ?>
                                                        <a href="<?= base_url() ?>admin/doctor_subscription_plans/changeStatus/<?= $plan->id ?>/0" 
                                                           class="btn btn-xs btn-warning" title="Deactivate"
                                                           onclick="return confirm('Are you sure you want to deactivate this plan?')">
                                                            <i class="fa fa-ban"></i>
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="<?= base_url() ?>admin/doctor_subscription_plans/changeStatus/<?= $plan->id ?>/1" 
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="9" class="text-center">No doctor subscription plans found</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
$(document).ready(function() {
    ...
    $('.dataTables-example').DataTable({
        ...
        buttons: [
            ...
            {extend: 'pdf', title: 'Doctor Subscription Plans'},
            {extend: 'print',
