    ...
    <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>admin/doctor_categories/update">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" id="category_name" name="category_name" value="<?= $doctor_category->category_name; ?>" class="form-control">
                    ...
                    if ($doctor_category->app_image) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img width="200px" src="<?= base_url() ?>uploads/doctor_categories/<?= $doctor_category->app_image ?> "/>
