            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="<?= base_url() ?>admin/doctor_categories/add">
                            ...
                            <tbody>
                                ...
                                foreach ($categories as $cat) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <?php if($cat->app_image!=''){ ?>
                                            <a href="<?= base_url() ?>uploads/doctor_categories/<?= $cat->app_image ?>" target="_blank"><img class="cat_image" align="left" src="<?= base_url() ?>uploads/doctor_categories/<?= $cat->app_image ?>" title="category image"></a>
                                            <?php } ?></td>
                                        <td>
                                            <?php 
                                            if($cat->status==1){?>
