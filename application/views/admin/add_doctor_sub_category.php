    ...
    <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url() ?>admin/doctor_sub_categories/insert">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Sub Symptom </label>
                   ...
                   <!--  <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="file" id="app_image" name="app_image" class="form-control">
                             ...
                             <span class="help-block m-b-none" style="color:red;">Image Width : 500px and height : 500px</span>
...
<script type="text/javascript">
  ...
  $('#btn_subcategory').click(function(){
      ...
      if($('#cat_id').val()=='')
      {
         $('#cat_id').after('<span class="error" style="color:red;font-size: 18px;margin-left: 18px;">Select Category (Symptom )</span>');
         $('#cat_id').focus();
         return false;
      }
