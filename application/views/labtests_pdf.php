...
<html>
 ...
 border:1px solid #ccc; padding: 25px;">
            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <td width="20">&nbsp;</td>
                                 <td width="490" align="right">
                                    <div style="font-size: 15px; margin-bottom: 5px; text-align: right;">
                                        <p style="margin:0px; padding: 0px 0px 5px 0px;"><strong style="font-size: 20px;">Date : <span><?=date('d-m-Y')?></span><strong></p>
                            ...
                            <tr>
                                <td width="1000" valign="top">
                                    <div style="font-size: 15px; margin-bottom: 5px; text-align:left">
                                        ...
                                        <p style="margin:0px; padding: 0px 0px 5px 0px;"><?= $diag->chief_complaints ?> </p>
                ...
                <!--<?php if($pres->manual_prescription!=''){ ?>-->
                <!-- <tr>-->
                <!--    <td> <p style="margin:0px; padding:0px 0px 5px 0px; font-size: 16px; color: #000; text-decoration: underline;"><strong>Manual Prescription</strong></p></td>-->
                <!--</tr>-->
                <!--<tr>-->
                <!--    <td> <table width="100%" cellpadding="15" cellspacing="0">-->
                <!--            <tr>-->
                <!--                <th style="padding:10px 0px;">SI.</th>-->
                <!--                <th style="padding:10px 0px;">Image</th>-->
                         
                <!--            </tr>-->
                            
                <!--            <tr style="padding: 8px 0px">-->
                <!--                <td style="padding: 8px 0px">1.</td>-->
                <!--                    <td>-->
                <!--                        <?php if($pres->manual_prescription!=''){ ?>-->
                <!--                        <img src="<?php echo base_url(); ?>uploads/prescription/<?= $pres->manual_prescription; ?>" style="width: 60px; height: 60px;">-->
                <!--                        <?php } ?>-->
                <!--                    </td>-->
                ...
                <br><br><br>
                 <tr>
                    <td></td>
                    <td style="font-size: 20px;" ><h4>Reg.No :</h4></td>

                    <td style="font-size: 17px;" colspan="2"><?=$doc_det->doctor_license_no?></td>
                ...
                <tr>
                     <td></td>
                    <td style="font-size: 20px;" ><h4>Doctor :</h4></td>
                    <td style="font-size: 17px;" colspan="2"><?=$doc_det->doctor_name?></td> 
                    
                   
                </tr>
                <tr> 
                       <td></td>
                       <td style="font-size: 20px;" ><h4>Doctor Signature:</h4></td>
                       <td colspan="2">   <?php if($doc_det->digital_signature!=''){ ?>
                           <img src="<?php echo base_url(); ?>uploads/doctors/<?= $doc_det->digital_signature; ?>" style="width: 60px; height: 60px;"> 
                          <?php } ?></td>
                       <td>
