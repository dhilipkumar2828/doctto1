...
//                    echo json_encode($send);
    ...
    function day_schedules($doctor_id, $date)
    {
        ...
        $this->db->select("id,patient_id,doctor_id,doctor_status,date,time_slot_name,time_slot_value,consultation_fee,patient_name,patient_mobile,patient_age,created_date,patient_visiting_purpose,appointment_type, 'offline' as source");
        $this->db->where("doctor_id", $doctor_id);
        $this->db->where("doctor_status", 'accept');
        if ($date != '') {
            $this->db->where("date", $date);
    ...
    function waiting_accepting($doctor_id, $doctor_status)
    {
        ...
        $today = date('Y-m-d');
        $table = "doctor_appointments";
        $this->db->select("id,patient_id,doctor_id,doctor_status,date,time_slot_name,time_slot_name,time_slot_value,consultation_fee,patient_name,patient_mobile,patient_age,patient_visiting_purpose,created_date,appointment_type, 'offline' as source");
        $this->db->where("doctor_id", $doctor_id);
        $this->db->where("doctor_status", $doctor_status);
