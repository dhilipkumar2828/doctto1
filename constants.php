...
define('DEFAULT_IMAGE_PATH', $url . "uploads/products/default.png");
...
// PhonePe Official PHP SDK Configuration
// Using working production credentials for testing
define("PHONEPE_CLIENT_ID", 'M1Y5YWMA86HR'); // Working production Client ID
define("PHONEPE_CLIENT_SECRET", '168028f5-f3cf-40e3-a320-120926e1dcfb'); // Working production Client Secret
define("PHONEPE_CLIENT_VERSION", '1.0');
define("PHONEPE_ENVIRONMENT", 'PRODUCTION'); // Using production for testing

// PhonePe Configuration for Doctor Subscriptions
// Using working production credentials
define("PHONEPE_SANDBOX_BASE_URL", 'https://api.phonepe.com/apis/hermes');
define("PHONEPE_SANDBOX_MERCHANT_ID", 'M1Y5YWMA86HR'); // Working production Merchant ID
define("PHONEPE_SANDBOX_SALT_KEY", '168028f5-f3cf-40e3-a320-120926e1dcfb'); // Working production Salt Key
define("PHONEPE_SANDBOX_SALT_INDEX", 1);
